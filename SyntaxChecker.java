...
public class SyntaxChecker {
	...
	//Constructor holds the original expression
	//and a stack to hold each element
	...
	public boolean checkExpression() {
		...
		/**returns 'true' if balance of symbols is correct
		   returns 'false if balance of symbols is incorrect
		*/
	}
